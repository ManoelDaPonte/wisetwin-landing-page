          ...
          >
            <Card className="h-full hover:shadow-md transition-all duration-200">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-semibold mb-4">WiseTrainer</h3>
                <p className="text-muted-foreground mb-6">
                  Notre solution phare de formation industrielle en 3D. Créez
                  des expériences d'apprentissage immersives sans équipement VR.
                </p>
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center gap-2 text-sm text-muted-foreground">
                    <div className="size-1.5 rounded-full bg-blue-400/60"></div>
                    Suivez la progression des apprenants avec des analyses
                    détaillées
                  </li>
                </ul>
              ...
              <Card className="hover:shadow-md transition-all duration-200">
                <CardContent className="p-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2">WiseTour</h3>
                      <p className="text-muted-foreground mb-4">
                        Visites industrielles virtuelles en 3D pour présenter
                        vos installations et valoriser votre savoir-faire.
                      </p>
              ...
              <Card className="hover:shadow-md transition-all duration-200">
                <CardContent className="p-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2">WiseScan</h3>
                      <p className="text-muted-foreground">
                        Analyse intelligente des accidents pour des
              ...
              <Card className="hover:shadow-md transition-all duration-200">
                <CardContent className="p-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2">WiseAssist</h3>
                      <p className="text-muted-foreground">
                        Assistant IA pour guider vos équipes et répondre à leurs
