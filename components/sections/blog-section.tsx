		...
		>
			<div className="grid md:grid-cols-3 gap-12">
				...
				<Link
					...
					className="group"
				>
					<Card noPaddingTop className="h-full flex flex-col hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer ">
						{/* Image de couverture (simulation) */}
						<div className="h-32 bg-wisetwin-blue/20 relative flex items-center justify-center">
