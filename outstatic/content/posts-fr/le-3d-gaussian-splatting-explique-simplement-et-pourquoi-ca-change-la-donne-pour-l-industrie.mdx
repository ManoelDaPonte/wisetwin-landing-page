...
Des équipes de recherche travaillent déjà sur des pipelines qui fusionnent Gaussian Splatting et IoT pour obtenir un jumeau numérique "vivant", mis à jour en temps réel ([Centosoftware, 2025](https://centosoftware.com/2025/11/28/digital-twin-architecture-for-manufacturing/)). C'est exactement la direction dans laquelle on pousse.
